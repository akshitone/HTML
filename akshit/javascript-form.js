function validate()
            {
                ...
                if(x.trim()=="")
                {
                    document.getElementById("msglog1").innerHTML="*Please insert username";
                    return false;
                }
                else if(y.trim()=="")
                {
                    document.getElementById("msglog2").innerHTML="*Please insert password";
                    return false;
                }
                else if(y.length < 4)
                {
                    document.getElementById("msglog2").innerHTML="*Password must be more then 4 character";
                    return false;
                }
                else if(y.search(/[0-9]/) ==-1)
                {
                    document.getElementById("msglog2").innerHTML="*Password must contain one numeric value";
                    return false;
                }
                else if(y.search(/[a-z]/) ==-1)
                {
                    document.getElementById("msglog2").innerHTML="*Password must contain one lowerCase alphabet";
                    return false;
                }
                else if(y.search(/[A-Z]/) ==-1)
                {
                    document.getElementById("msglog2").innerHTML="*Password must contain one upperCase alphabet";
                    return false;
                }
                else if(y.search(/[!\@\#\$\%\^\&\*]/) ==-1)
                {
                    document.getElementById("msglog2").innerHTML="*Password must contain one symbol";
                    return false;
                }
                else
                {
